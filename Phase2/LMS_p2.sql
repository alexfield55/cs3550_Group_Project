...
(
	...
	constraint prim_deptID primary key (deptID)
);
...
(
    ...
    constraint foreign_deptID_class foreign key (deptID) references department(deptID)  
);
...
(
    ...
    constraint foreign_teacherID_section foreign key (teacherID) references teacher(teacherID),
    constraint foreign_classID_section foreign key (classID) references class(classID)
);
...
(
    ...
    constraint foreign_sectionID_assignment foreign key(sectionID) references section(sectionID),
...
(
    ...
    constraint foreign_sectionID_ss foreign key(sectionID) references section(sectionID),
    constraint foreign_studentID_ss foreign key(studentID) references student(studentID),
...
(
    ...
    constraint foreign_sectionID_announcements foreign key(sectionID) references section(sectionID)
);